    ...
    <>
      ...
      <section className="flex mt-5 mb-5 flex-col">
        ...
        <p>
          ...
          nostres infants. Necessitem mans, moltes mans... com més, millor.
          ...
          involucrar-vos en la Junta... el que vulgueu o pugueu, però necessitem
          COMPROMÍS I AJUDA per part vostra, ja que està sent molt difícil tirar
          endavant sense suport de les mares i pares del Gerbert. Totes juntes
          podem construir l'escola que volem i lluitar perquè cada dia, els
          nostres nens i nenes tinguin una millor educació i en millors
          condicions.
        </p>
        <div className="w-4/5">
          <Image
